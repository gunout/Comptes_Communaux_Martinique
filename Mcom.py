...
class MartiniqueCommuneFinanceAnalyzer:
    ...
    def _get_commune_config(self):
        """Retourne la configuration spécifique pour chaque commune"""
        configs = {
            "Fort-de-France": {
                "population_base": 85000,
                "budget_base": 180,
                "type": "urbaine",
                "specialites": ["administration", "commerce", "sante", "education"]
            },
            "Le Lamentin": {
                "population_base": 40000,
                "budget_base": 90,
                "type": "urbaine",
                "specialites": ["industrie", "aeroport", "zones_activites"]
            },
            "Le Marin": {
                "population_base": 8800,
                "budget_base": 25,
                "type": "cotiere",
                "specialites": ["tourisme", "nautisme", "commerce"]
            },
            "Sainte-Marie": {
                "population_base": 18000,
                "budget_base": 35,
                "type": "rurale",
                "specialites": ["agriculture", "culture", "tourisme"]
            },
            "Rivière-Pilote": {
                "population_base": 13500,
                "budget_base": 28,
                "type": "rurale",
                "specialites": ["agriculture", "artisanat", "commerce"]
            },
            ...
            "default": {
                ...
                "budget_base": 22,
                "type": "rurale",
                "specialites": ["agriculture", "petit_commerce", "services"]
            }
        }
    ...
    def generate_financial_data(self):
        ...
        # Ajouter des tendances spécifiques à la commune
    ...
    def _simulate_households(self, dates):
        ...
        base_households = self.config["population_base"] / 2.5  # estimation
    ...
    def _simulate_tax_revenue(self, dates):
        ...
        base_tax = self.config["budget_base"] * 0.4  # 40% du budget
    ...
    def _simulate_state_grants(self, dates):
        ...
        base_grants = self.config["budget_base"] * 0.35  # 35% du budget
    ...
    def _simulate_other_revenue(self, dates):
        ...
        base_other = self.config["budget_base"] * 0.25  # 25% du budget
    ...
    def _simulate_total_expenses(self, dates):
        ...
        base_expenses = self.config["budget_base"] * 0.95  # 95% des recettes
    ...
    def _simulate_operating_expenses(self, dates):
        ...
        base_operating = self.config["budget_base"] * 0.6  # 60% du budget
    ...
    def _simulate_investment_expenses(self, dates):
        ...
        base_investment = self.config["budget_base"] * 0.35  # 35% du budget
    ...
    def _simulate_debt_charges(self, dates):
        ...
        base_debt_charge = self.config["budget_base"] * 0.05  # 5% du budget
    ...
    def _simulate_staff_costs(self, dates):
        ...
        base_staff = self.config["budget_base"] * 0.4  # 40% du budget
    ...
    def _simulate_gross_savings(self, dates):
        ...
        savings = []
        for i, date in enumerate(dates):
            base_saving = self.config["budget_base"] * 0.05  # 5% du budget
    ...
    def _simulate_total_debt(self, dates):
        ...
        base_debt = self.config["budget_base"] * 0.7  # 70% du budget annuel
    ...
    def _simulate_agriculture_investment(self, dates):
        ...
        multiplier = 1.2 if "agriculture" in self.config["specialites"] else 0.8
    ...
    def _simulate_tourism_investment(self, dates):
        ...
        # Ajustement selon les spécialités
        multiplier = 1.5 if "tourisme" in self.config["specialites"] else 0.7
        ...
        for i, row in df.iterrows():
            ...
            if 2020 <= year <= 2021:
                if year == 2020:
                    ...
                    df.loc[i, 'Fonctionnement'] *= 1.03
            
            # Développement durable (augmentation des investissements environnementaux)
            if year >= 2010:
                environment_growth = 1 + 0.035 * (year - 2010)
                df.loc[i, 'Investissement_Environnement'] *= environment_growth
            
            # Plan de relance post-COVID (2022-2025)
            if year >= 2022:
                df.loc[i, 'Investissement'] *= 1.12
                df.loc[i, 'Investissement_Tourisme'] *= 1.15
                df.loc[i, 'Investissement_Agriculture'] *= 1.1
    ...
    def create_financial_analysis(self, df):
        ...
        plt.suptitle(f'Analyse des Comptes Communaux de {self.commune} ({self.start_year}-{self.end_year})', 
    ...
    def _plot_sectorial_investments(self, df, ax):
        ...
        categories = ['Investissement_Agriculture', 'Investissement_Tourisme', 
                     'Investissement_Transport', 'Investissement_Education', 'Investissement_Environnement']
        colors = ['#264653', '#2A9D8F', '#E76F51', '#F9A602', '#6A0572']
        labels = ['Agriculture', 'Tourisme', 'Transport', 'Éducation', 'Environnement']
    ...
    def _generate_financial_insights(self, df):
        ...
        print(f"🏛️ INSIGHTS ANALYTIQUES - Commune de {self.commune}")
        print("=" * 60)
        ...
        print("• 2010-2015: Développement des activités spécifiques")
        ...
        if "agriculture" in self.config["specialites"]:
            print("• Développer l'agriculture biologique et les filières locales")
        if "tourisme" in self.config["specialites"]:
            print("• Promouvoir le tourisme durable et les activités nature")
        if "culture" in self.config["specialites"]:
            print("• Valoriser le patrimoine culturel et historique")
        print("• Améliorer les infrastructures et les services de proximité")
        print("• Préserver les espaces naturels et la biodiversité")
        print("• Développer l'économie locale et l'artisanat")
        print("• Renforcer les services publics (santé, éducation, transport)")
...
def main():
    ...
    communes = [
        ...
        "Le Morne-Rouge", "Le Morne-Vert", "Le Prêcheur",
        "Rivière-Pilote", "Rivière-Salée", "Le Robert", "Sainte-Anne",
        "Sainte-Luce", "Sainte-Marie", "Saint-Esprit", "Saint-Joseph",
        "Saint-Pierre", "Schœlcher", "La Trinité", "Les Trois-Îlets", "Le Vauclin"
    ]
    
    print("🏛️ ANALYSE DES COMPTES COMMUNAUX DE LA MARTINIQUE (2002-2025)")
    print("=" * 60)
    ...
    try:
        ...
        print("Choix invalide. Sélection de Fort-de-France par défaut.")
        commune_selectionnee = "Fort-de-France"
    
    # Initialiser l'analyseur
    analyzer = MartiniqueCommuneFinanceAnalyzer(commune_selectionnee)
